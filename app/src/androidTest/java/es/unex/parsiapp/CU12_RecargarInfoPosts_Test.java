...
public class CU12_RecargarInfoPosts_Test {
    ...
    @Test
    public void cU12_RecargarInfoPosts_Test() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.username_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("RecargarInfo"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.email_register),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("cu12@gmail.com"), closeSoftKeyboard());
